...
import { Brain, Mail, Lock, ArrowRight, Github, User } from 'lucide-react';
...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen bg-[#050505] text-white flex flex-col items-center justify-center px-6 relative overflow-hidden" suppressHydrationWarning>
            {/* Background Orbs */}
            <div className="absolute top-[-10%] right-[-10%] w-[40%] h-[40%] bg-blue-600/10 blur-[120px] rounded-full -z-10" />
            <div className="absolute bottom-[-10%] left-[-10%] w-[40%] h-[40%] bg-emerald-600/10 blur-[120px] rounded-full -z-10" />
            ...
            >
                ...
                <p className="text-zinc-500 mb-8">Reconnect with your digital intelligence.</p>
                ...
                <form onSubmit={handleLogin} className="space-y-4">
                    ...
                    >
                        {loading ? 'Entering...' : 'Sign In'} <ArrowRight className="w-5 h-5" />
                    </button>
                </form>
                ...
                <p className="mt-8 text-center text-sm text-zinc-500">
                    New to Cognify? {' '}
                    <Link href="/auth/signup" className="text-blue-500 hover:underline font-semibold">Join Now</Link>
                </p>
            </motion.div>
        </div>
    );
